    ...
    <View style={styles.container8}>
      ...
      <View style={styles.nav8}>
        <TouchableOpacity onPress={() => navigation.navigate('Home')}>
          <Text style={sharedStyles.navItem8}>INÍCIO</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Contato')}>
          <Text style={sharedStyles.navItem8}>CONTATO</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Reservas')}>
          <Text style={sharedStyles.navItem8}>RESERVA</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Menu')}>
          <Text style={sharedStyles.navItem8}>CARDÁPIO</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Localizacao')}>
          <Text style={sharedStyles.navItem8}>LOCALIZAÇÃO</Text>
        </TouchableOpacity>
      </View>
...
function Contato({ navigation }) {
  return (
    ...
    <View style={styles.header3}>
      <Text style={styles.headerText3}>BOMBOIDI</Text>
    </View>
    <View style={styles.nav3}>
      <TouchableOpacity onPress={() => navigation.navigate('Home')}>
        <Text style={styles.navItem3}>INÍCIO</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate('Contato')}>
        <Text style={styles.navItem3}>CONTATO</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate('Reservas')}>
        <Text style={styles.navItem3}>RESERVA</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate('Menu')}>
        <Text style={styles.navItem3}>CARDÁPIO</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate('Localizacao')}>
        <Text style={styles.navItem3}>LOCALIZAÇÃO</Text>
      </TouchableOpacity>
    </View>
